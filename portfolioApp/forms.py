...
from .models import Project,Data,BMI_Calculater,Gallery,Video
...
class ImageUpload(forms.ModelForm):
    ...
    class Meta:
        model = Data
        fields = ['title', 'descriptions', 'technology','image']

class BMI(forms.ModelForm):
    weight = forms.CharField(max_length=250)
    height = forms.CharField(max_length=250)


    class Meta:
        model=BMI_Calculater
...
class VideoUpload(forms.ModelForm):
    video=forms.FileField(label="select an Video",required=True)
